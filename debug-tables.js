...
(function() {
    ...
    setTimeout(function() {
        ...
        if (patientsTable) {
            ...
            console.log('Patients rows count:', patientsBody ? patientsBody.rows.length : 'N/A');
            console.log('Patients tbody innerHTML length:', patientsBody ? patientsBody.innerHTML.length : 'N/A');
        ...
        if (sessionsTable) {
            ...
            console.log('Sessions rows count:', sessionsBody ? sessionsBody.rows.length : 'N/A');
            console.log('Sessions tbody innerHTML length:', sessionsBody ? sessionsBody.innerHTML.length : 'N/A');
        ...
        if (usersTable) {
            ...
            console.log('Users rows count:', usersBody ? usersBody.rows.length : 'N/A');
            console.log('Users tbody innerHTML length:', usersBody ? usersBody.innerHTML.length : 'N/A');
