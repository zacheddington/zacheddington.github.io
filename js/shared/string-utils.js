...
console.log('[DEBUG] string-utils.js: escapeHtml function defined, typeof escapeHtml =', typeof escapeHtml);
...
console.log('[DEBUG] string-utils.js: Finished loading. window.stringUtils =', window.stringUtils);
